...
# Monkeypatch torch_geometric to handle numpy array indexing
# This fixes an IndexError in newer torch_geometric versions when using graphgym
from torch_geometric.data import Dataset
original_getitem = Dataset.__getitem__
def patched_getitem(self, idx):
    if hasattr(idx, 'tolist') and not isinstance(idx, torch.Tensor):
        # Convert numpy arrays/scalars to lists/integers
        # print(f"DEBUG: Converting idx from type {type(idx)} to list/int for Dataset.__getitem__")
        idx = idx.tolist()
