...
def format(inputs, h5_name, labels, RSSI_val, phase_val, flags, lengths):
    ...
    output_root = r'C:\Users\golipos1\OneDrive - Aalto University\Desktop\P\RFIDSkeletonGestureRecognition\ForRevise\GraphModels\ICML\Coding\3m\SaveAsTensors\SavedTensor'
    num_epcs = 8
    target_length = 30
